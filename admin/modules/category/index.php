<?php
    ...
    $category = $db->fetchJone('category', $sql, $page, 10, true);
    ...
    $open = 'category';
    include('../../includes_admin/header_admin.php'); // them trong tung hang
?>
                                  ...
                                  <table class="table table-bordered" id="users" style="width: 100%; background-color: #c3d5ff">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?php echo $stt?></td>
                                            <td>
                                                <img src="<?php echo uploads()?>categories/<?php echo $item['banner']?>" width="80px" height="100px">
                                            </td>
