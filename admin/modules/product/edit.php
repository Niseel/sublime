    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        if(empty($error)){
           if(isset($_FILES['image'])){
            ...
            $row = $db->num_rows('product', $name);
            if(intval($row) < 1){
                if($db->update('product', $data, $id)){
                    $_SESSION['success'] = "Update new product successful";
                    move_uploaded_file($file_tmp, $path.$file_name);
                    redirectAdmin('product');
                }else{
                    $_SESSION['fail'] = "Update new product fail";
                    echo "Lỗi: " .$db->error();
                }
        }
    }
                        ...
                        <div class="col-md-12">
                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <select id="inputcategory" class="form-control" name="category_id">
                                        ...
                                        <?php foreach ($category as $item): ?>
                                            ...
                                            if(isset($data['category_id'])){
                                                ...
                                                if(isset($value['category_id']) && $value['category_id'] == $item['id']){
                                                    echo 'selected="selected"';
                                                }else{
                                                    echo '';
                                                }
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select id="inputbrand" class="form-control" name="brand_id">
                                        ...
                                        <?php foreach ($brand as $item): ?>
                                            <option value="<?php echo $item['id']?>"<?php echo $value['brand_id'] == $item['id'] ? "selected = 'selected'" : ''?>><?php echo $item['name']?></option>
                                        <?php endforeach ?>
                                    </select>
                                    <?php
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="newcategory" placeholder="Enter new product name" value="<?php echo isset($data['name']) ? $data['name'] : $value['name']?>" name="name">
                                    <?php
                                        if(isset($error['name'])){
                                            echo '<div class="text-danger">';
                                            echo $error['name'];
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="number" class="form-control" id="inputprice" placeholder="VND" value="<?php echo isset($data['price']) ? $data['price'] : $value['price']?>" name="price">
                                    <?php
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="number" class="form-control" id="inputsale" placeholder="%" value="<?php echo isset($data['sale']) ? $data['sale'] : $value['sale']?>" name="sale">
                                </div>
                                <div class="form-group col-md-3">
                                    <label for="inputsale">Amount</label>
                                    <input type="number" class="form-control" id="inputamount" placeholder="Amount of product" value="<?php echo isset($data['amount']) ? $data['amount'] : $value['amount']?>" name="amount">
                                    <?php
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <img src="<?php echo uploads()?>products/<?php echo $value['image']?>" width="80px" height="100px">
                                    <?php
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea class="form-control" id="textinput" rows="4" name="content"><?php echo isset($data['content']) ? $data['content'] : $value['content']?></textarea>
                                    <?php
