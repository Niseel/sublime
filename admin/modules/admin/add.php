<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        if(empty($error)){
            ...
            $row = $db->insert('admin', $data);
            if($row){
                $_SESSION['success'] = "Add admin successful";
                redirectAdmin('admin');
            }else{
                $_SESSION['fail'] = "Add admin fail";
                echo "Lỗi: " .$db->error();
            }
        }
    }
                        ...
                        <div class="col-md-12">
                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="newadmin" placeholder="Enter new admin name" value="<?php echo isset($data['name']) ? $data['name'] : '' ?>" name="name">
                                    <?php
                                        if(isset($error['name'])){
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="email" class="form-control" id="mailadmin" placeholder="Enter admin email" value="<?php echo isset($data['mail']) ? $data['mail'] : '' ?>" name="mail">
                                    <?php
                                        if(isset($error['mail'])){
                                            echo '<div class="text-danger">';
                                            echo $error['mail'];
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select id="inputbrand" class="form-control" name="level">
                                        <option value="1" <?php echo isset($data['level']) && $data['level'] == 1 ? 'selected = "selected"' : ''?>>SALE</option>
                                        <option value="2" <?php echo isset($data['level']) && $data['level'] == 2 ? 'selected = "selected"' : ''?>>MANEGER</option>
                                    </select>
                                    <?php
