...
<?php
    ...
    if(empty($value)){
        $_SESSION['error'] = '<script type="text/javascript">alert("No orders exsit");</script>';
    ...
    $sum = 0;
    $user_id = intval($_SESSION['login']['name_id']);
    $sql1 = "SELECT orders.*, user.name as user_name FROM orders LEFT JOIN user on user.id = orders.user_id WHERE orders.id = $id AND orders.user_id = $user_id";
	                        ...
	                        <div class="home_content">
	                            <div class="breadcrumbs">
	                                <ul>
	                                    ...
	                                    <li id="sd">Detail List Invoices</li>
	                                </ul>
	                            </div>
	                        </div>
	                    </div>
	    ...
	    <div class="container" style="color: black">
			<div class="row">
				<div class="col-md-6">
                    ...
                    <b>Employees Name (ID):&emsp; Unknown</b></br>
