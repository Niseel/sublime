...
<?php
	// $sql = 'SELECT * FROM product WHERE status = 1 AND category_id = '.$id.' LIMIT ' .$number_product_start. ', ' .$limit. ';';
	$sql = "SELECT * FROM product WHERE status = 1 AND slug LIKE '%$name%' LIMIT $number_product_start, $limit;";
